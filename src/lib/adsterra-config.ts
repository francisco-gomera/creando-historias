...
export const ADSTERRA_KEYS = {
  ...
  banner300x250: process.env.NEXT_PUBLIC_ADSTERRA_BANNER_300X250 || "6fafdce6f3fabc9754c6459b66c1f874",
  banner160x600: process.env.NEXT_PUBLIC_ADSTERRA_BANNER_160X600 || "071346b6b07e5018a334d9e33592e2f3",
  banner160x300: process.env.NEXT_PUBLIC_ADSTERRA_BANNER_160X300 || "8f83d45deeed21707aea6554d8af98da",
